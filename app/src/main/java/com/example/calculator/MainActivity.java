...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_bt= findViewById(R.id.sin_bt);
        sub_bt= findViewById(R.id.cos_bt);
        mul_bt= findViewById(R.id.root_bt);
        div_bt= findViewById(R.id.sqr_bt);
    ...
    public void open_advanced_activity(){
        ...
        intent.putExtra("snum1",snum1);
        intent.putExtra("snum2",snum2);
